...
# 这是 Windows + numpy + PyTorch 多线程冲突，属于环境问题。
# 加那 4 行就是告诉系统：允许重复加载、只开单线程，避免冲突。
...
class DiyBert:
    ...
    def forward(self, x):
        ...
        # Google官方BERT代码、Hugging，Face，Transformers库，全部统一取sequence_output[:, 0]或sequence_output[0]。
